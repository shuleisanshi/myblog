        ...
        <div class="top-nav">
            <div class="user-login">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="/admin">Enter backend</a>
                    </c:otherwise>
                </c:choose>
                <a href="https://shuleisanshi.com/" target="_blank" style="color:red;">  /Connect to my website</a>
            </div>
                        ...
                        <ul id="menu-pcmenu" class="down-menu nav-menu sf-js-enabled sf-arrows">
                            ...
                            <li>
                                <a href="/">
                                    ...
                                    <span class="font-text">Homepage</span>
                                </a>
                            </li>
...
<div id="search-main">
    <div class="searchbar">
        <form method="get" id="searchform" action="/search" accept-charset="UTF-8">
            <span>
                <input type="text" value="" name="keywords" id="s" placeholder="Input keywords"required="">
